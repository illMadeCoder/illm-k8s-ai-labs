...
Located at `experiments/components/apps/hello-app/`:
...
1. **Make a change** to any file in `experiments/components/apps/hello-app/`
...
kubectl apply -f experiments/components/apps/hello-app/hello-app.yaml

# Or deploy directly
kubectl apply -k experiments/components/apps/hello-app/k8s/
